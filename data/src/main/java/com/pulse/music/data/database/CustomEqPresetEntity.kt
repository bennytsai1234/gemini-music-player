 ...
 * 轉換為 Domain Model
 */
fun CustomEqPresetEntity.asDomainModel() = com.pulse.music.domain.model.CustomEqPreset(
    id = id,
    name = name,
 ...
 */
fun com.pulse.music.domain.model.CustomEqPreset.asEntity() = CustomEqPresetEntity(
    id = id,
    name = name,
